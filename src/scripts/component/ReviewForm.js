    ...
    return `
      <form action="#" class="review-form">
        <div class="form-input">
          <input id="name-input" type="text" placeholder="Enter your name" aria-label="Name Input" />
          <span class="name-error"></span>
        </div>
        <div class="form-input">
          <textarea id="review-input" rows="3" placeholder="Write your review here..." aria-label="Review Input"></textarea>
